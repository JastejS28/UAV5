...
const THERMAL_MATERIALS = {
  ...
  uav: new THREE.MeshBasicMaterial({ color: 0xFFFF00, emissive: 0xFFFF00, emissiveIntensity: 1.5 }), // Much brighter yellow for UAV
  tank: new THREE.MeshBasicMaterial({ color: 0xFF6600, emissive: 0xFF6600, emissiveIntensity: 1.5 }), // Much brighter orange for tank
  jeep: new THREE.MeshBasicMaterial({ color: 0xFF8800, emissive: 0xFF8800, emissiveIntensity: 1.5 }), // Much brighter yellow-orange for jeep
  soldier: new THREE.MeshBasicMaterial({ color: 0xFFAA00, emissive: 0xFFAA00, emissiveIntensity: 1.5 }), // Much brighter yellow for soldier
  warehouse: new THREE.MeshBasicMaterial({ color: 0xFF4400, emissive: 0xFF4400, emissiveIntensity: 1.2 }), // Brighter red-orange for warehouse
  armyBase: new THREE.MeshBasicMaterial({ color: 0xFF6600, emissive: 0xFF6600, emissiveIntensity: 1.2 }), // Brighter orange for army base
};
